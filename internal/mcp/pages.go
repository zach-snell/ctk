...
func ManagePagesHandler(c *confluence.Client, canWrite bool) func(context.Context, *mcp.CallToolRequest, ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	return func(ctx context.Context, req *mcp.CallToolRequest, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
		switch args.Action {
		case "get":
			return handleGetPage(c, args)
		case "get_by_title":
			return handleGetPageByTitle(c, args)
		case "list":
			return handleListPages(c, args)
		case "get_children":
			return handleGetChildren(c, args)
		case "get_ancestors":
			return handleGetAncestors(c, args)
		case "create":
			return handleCreatePage(c, canWrite, args)
		case "update":
			return handleUpdatePage(c, canWrite, args)
		case "delete":
			return handleDeletePage(c, canWrite, args)
		case "list_versions":
			return handleListVersions(c, args)
		case "move":
			return handleMovePage(c, canWrite, args)
		case "diff":
			return handleDiffPage(c, args)
		default:
...
func handleGetPage(c *confluence.Client, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if args.PageID == "" {
...
func handleGetPageByTitle(c *confluence.Client, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if args.SpaceID == "" {
...
func handleListPages(c *confluence.Client, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if args.SpaceID == "" {
...
func handleGetChildren(c *confluence.Client, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if args.PageID == "" {
...
func handleGetAncestors(c *confluence.Client, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if args.PageID == "" {
...
func handleCreatePage(c *confluence.Client, canWrite bool, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if !canWrite {
...
func handleUpdatePage(c *confluence.Client, canWrite bool, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if !canWrite {
		return ToolResultError("write operations are disabled. Set CTK_ENABLE_WRITES=true to enable."), nil, nil
	}
...
func handleDeletePage(c *confluence.Client, canWrite bool, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if !canWrite {
		return ToolResultError("write operations are disabled. Set CTK_ENABLE_WRITES=true to enable."), nil, nil
	}
	if args.PageID == "" {
...
func handleListVersions(c *confluence.Client, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if args.PageID == "" {
...
func handleMovePage(c *confluence.Client, canWrite bool, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if !canWrite {
		return ToolResultError("write operations are disabled. Set CTK_ENABLE_WRITES=true to enable."), nil, nil
	}
	if args.PageID == "" {
...
func handleDiffPage(c *confluence.Client, args ManagePagesArgs) (*mcp.CallToolResult, any, error) {
	if args.PageID == "" {
